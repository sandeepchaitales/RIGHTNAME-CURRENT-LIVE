...
async def evaluate_brands(request: BrandEvaluationRequest):
    ...
    if LlmChat and EMERGENT_KEY:
        # gpt-4o for quality, with fast fallback
        models_to_try = [
            ("openai", "gpt-4o"),                          # Primary - Best quality with dimensions
            ("anthropic", "claude-sonnet-4-20250514"),     # Fallback 1 - Claude
            ("openai", "gpt-4o-mini"),                     # Fallback 2 - Fast but less detail
        ]
    else:
